package com.tingshulien.grpc.unary.validator;
...
public class Validation {
  ...
  public static final Key<String> VALIDATION_CODE_KEY = Metadata.Key.of("validation-code", Metadata.ASCII_STRING_MARSHALLER);
